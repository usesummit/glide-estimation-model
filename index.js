(()=>{var w=Object.defineProperty,v=Object.defineProperties;var x=Object.getOwnPropertyDescriptors;var y=Object.getOwnPropertySymbols;var L=Object.prototype.hasOwnProperty,b=Object.prototype.propertyIsEnumerable;var d=(t,e,n)=>e in t?w(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,l=(t,e)=>{for(var n in e||(e={}))L.call(e,n)&&d(t,n,e[n]);if(y)for(var n of y(e))b.call(e,n)&&d(t,n,e[n]);return t},g=(t,e)=>v(t,x(e));var p=(t,e,n)=>new Promise((m,a)=>{var i=r=>{try{o(n.next(r))}catch(u){a(u)}},s=r=>{try{o(n.throw(r))}catch(u){a(u)}},o=r=>r.done?m(r.value):Promise.resolve(r.value).then(i,s);o((n=n.apply(t,e)).next())});function f(t){return t instanceof Date?t.toISOString():Array.isArray(t)?t.map(f):t}function M(t,e){return p(this,null,function*(){var o;let{data:{key:n,params:m}}=t,a,i;try{a=yield e(...m)}catch(r){a=void 0;try{i=r.toString()}catch(u){i="Exception can't be stringified."}}let s={key:n};a!==void 0&&(a=f(a),s.result={type:"string",value:a}),i!==void 0&&(s.error=i),((o=t.source)==null?void 0:o.postMessage).call(o,s,"*")})}function h(t){return typeof window!="undefined"&&window.addEventListener("message",e=>M(e,t.run)),g(l({},t),{json:JSON.stringify(D(t),null,2)})}var N=`
        <svg
          width="48"
          height="48"
          viewBox="0 0 26 27"
